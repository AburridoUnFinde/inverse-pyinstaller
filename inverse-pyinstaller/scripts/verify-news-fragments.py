#!/usr/bin/env python3
#-----------------------------------------------------------------------------
# Copyright (c) 2013-2022, Inverse-PyInstaller Development Team.
#
...
CHANGELOG_GUIDE = (
    "https://github.com/AburridoUnFinde/inverse-pyinstaller/tree/main/inverse-pyinstaller"
    "/doc/development/changelog-entries.rst#changelog-entries"
)
